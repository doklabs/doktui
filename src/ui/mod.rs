...
fn render_content(frame: &mut Frame, area: Rect, state: &AppState) {
    ...
    match state.screen {
        ...
        Screen::Apps => views::apps::render(frame, area, state),
        Screen::AppCanvas => views::app_canvas::render(frame, area, state),
        Screen::NewAppWizard => views::new_app_wizard::render(frame, area, state),
        Screen::GitProviders => views::git_providers::render(frame, area, state),
